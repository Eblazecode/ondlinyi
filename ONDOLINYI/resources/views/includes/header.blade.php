    ...
    <div class="container">
        ...
        <div class="navbar-header">
            <div class="container">
                ...
                <a class="navbar-brand to-top" href="#"><img src="{{asset('img/logos/4x/Asset%201Logo.png')}}"
                                                             class="logo-light" alt="#">
                    <img src="{{asset('img/logos/4x/Asset%202Logo.png')}}" class="logo-dark" alt="#"></a>
            </div>
        </div>
                            ...
                            <li class="megamenu-content withdesc">
                                ...
                                <div class="col-md-3 mg-col">
                                    <ul>
                                        ...
                                        <li><a href="elements.html#elements-maps">Maps</a></li>
