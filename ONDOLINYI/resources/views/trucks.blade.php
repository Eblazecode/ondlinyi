...
<section class="pt140 pb50">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <h1><strong>Trucks </strong>of high quality</h1>
            ...
            <div class="col-md-8 mt20 mb40">
                <div class="carousel lightbox" data-autoplay="false" data-speed="4000" data-touch-drag="true" data-loop="false">
                    <div><a href="img/backgrounds/dofeng.jpg"><img src="img/backgrounds/dofeng1.jpg" class="img-responsive width100" alt="#"></a></div>
                    <div><a href="img/backgrounds/truck.jpg"><img src="img/backgrounds/truck.jpg" class="img-responsive width100" alt="#"></a></div>
                    <div><a href="img/backgrounds/trucks.jpg"><img src="img/backgrounds/trucks.jpg" class="img-responsive width100" alt="#"></a></div>
                </div>
            </div>
            <!-- Sidebar -->
