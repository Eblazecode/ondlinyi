...
<section class="pt140 pb50">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <h1><strong>MDF wood </strong>with quality</h1>
            ...
            <div class="col-md-8 mt20 mb40">
                <div class="carousel lightbox" data-autoplay="false" data-speed="4000" data-touch-drag="true" data-loop="false">
                    <div><a href="img/backgrounds/mdfwood.jpg"><img src="img/backgrounds/mdfwood.jpg" class="img-responsive width100" alt="#"></a></div>
                    <div><a href="img/backgrounds/"><img src="img/backgrounds/ethanol.jfif" class="img-responsive width100" alt="#"></a></div>
                    <div><a href="img/backgrounds/ethdrums.jpg"><img src="img/backgrounds/ethdrums.jpg" class="img-responsive width100" alt="#"></a></div>
                </div>
            </div>
            <!-- Sidebar -->
